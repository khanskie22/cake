...
<html lang="en">
  ...
  <body>
        <div class="container-fluid" >
            <form class="mx-auto" picture method="POST" action="backend/logindb.php">
                ...
                <div class="mb-2">
                  ...
                  <div id="emailHelp" class="form-text mt-3" ><a href="signin.php" style="text-decoration: none;">Already Have an account?</a> </div>
                </div>
              <center>
                <div>
